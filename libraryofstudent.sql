...
--
create database libraryofstudent;
-- --------------------------------------------------------
...
('admin', 'admin', 'Dương Minh Thành', '0981249458', 'duongminhthanh1999td@gmail.com', 'KTX khu A', '1999-11-28', 0, 1234567899, 'Yeu mau xanh, get mau vang'),
('exchange', 'exchange', 'Vũ Ngọc Hào', '0981249458', 'vnhao@gmail.com', 'KTX khu B', '1999-05-12', 2, 1234567, 'yêu màu hồng, thích màu tím'),
('library', 'library', 'Vũ Ngọc Hào', '0981249457', 'library@gmail.com', 'KTX khu B', '1999-05-12', 1, 1123457899, 'yêu màu hồng, thích màu tím');
...
/*insert */
insert `bookoflibrary`(`BOOK_ID`,`BOOK_NAME`,`BOOK_TYPE`,`BOOK_IMAGE`,`DESCRIPTION`,`BOOK_COST`,`BOOK_NUMBER`) values
(1,'Twilight','Novel','images/Twilight.jpg','Ma cà rồng ,lãng mạn',144000,100),
(2,'The witcher','Novel','images/The witcher.jfif','Thuật sĩ,thợ săn quái vật',126000,200),
(3,'I am number four','Novel','images/I_Am_Number_Four.jpg','Người ngoài thành tinh,siêu năng lực',188000,150),
(4,'War and peace','Novel','images/sach-chien-tranh-va-hoa-binh.jpg','Tiểu thuyết ,lịch sử',316000,170),
(5,'Sherlock Holmes','Novel','images/sherlock-holmes-toan-tap.jpg','Tiểu thuyết ,trinh thám',350000,190),
(6,'Robinson trên hoang đảo','Novel','images/robinson.jfif','Tiểu thuyết ,sinh tồn',400000,200),
(7,'Cuốn theo chiều gió','Novel','images/cuốn theo chiều gió.jfif','Tiểu thuyết ,lãng mạn',500000,250),
(8,'Code dạo ký sự','Sách cho IT','images/code dạo ký sự.jfif','Sách dành cho dân IT',450000,200),
(9,'Người trong muôn nghề','Sách hướng nghiệp','images/Người trong muôn nghề.jfif','Sách dành cho người theo đuổi 1 nghề nghiệp cụ thể',495000,110),
(10,'Bố già','Novel','images/bố già.jfif','Sách tội phạm viễn tưởng,giật gân',500000,210);
...
delete from bookoflibrary ;
select * from bookofstudent join student where bookofstudent.STUDENT_ID=student.STUDENT_ID and BOOK_REQUEST_CREATE=0;